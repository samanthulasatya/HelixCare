...
start "Patient-Service" cmd /c "cd patient-service && mvn spring-boot:run"

echo Starting Doctor-Service (Port 8086)...
start "Doctor-Service" cmd /c "cd doctor-service && mvn spring-boot:run"

echo Starting Appointment-Service (Port 8087)...
start "Appointment-Service" cmd /c "cd appointment-service && mvn spring-boot:run"

echo Starting Billing-Service (Port 8088, gRPC 9090)...
start "Billing-Service" cmd /c "cd billing-service && mvn spring-boot:run"
